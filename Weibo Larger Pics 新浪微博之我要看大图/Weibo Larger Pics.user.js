...
在这里可以强制指定新浪图片服务器的地址（只对画廊模式和图片源按钮有效）。通常情况新浪的图片服务器（ww*.sinaimg.cn）会根据你的地址和网络分配最合适的服务器和 CDN，但是有时新浪分配的服务器和 CDN 速度很慢，这时可以强制指定一个速度更快的服务器为你服务。

一般情况下建议使用“新浪分配”，仅在某些图片无法加载或加载很慢时才特别指定服务器，并选择“在此页面临时使用”。

以下数值单位为毫秒，最后一列为同一图片的三次测速平均值。超时记为 5000 毫秒。
...
根据微博图像名反查上传者微博，填入格式为abcdefg0123456789.jpg

输入文件名 
 访问

http://xia.im/">我的博客http://xia.im/weibo-larger-pics-userscript/">反馈GreasyForkhttps://greasyfork.org/scripts/5038-weibo-larger-pics">GreasyFork href="Githubhttps://github.com/neverweep/Weibo-Larger-Pics/">Github style="color:red;font-weight:bold" href="http://xia.im/upload/donation.html">捐赠关闭
