...
// @version      1.0.0
// @author       mission522
// @description  在 JavDB、JavBus、JavLibrary 网站的影片详情页添加跳转在线播放按钮，并在按钮上标注是否存在可播放资源，资源是否为「字幕」、「无码」等信息。
// @license      MIT
...
 
var vite_plugin_monkey_271efac60a87 = function(exports) {
  var _a, _b;
  "use strict";
  ...
  async function main(HOSTNAME) {
    const cms = matchList.find((item) => item.hostname === HOSTNAME);
