  ...
  function PanHelper() {
    ...
    function batchClick(event) {
      ...
      if (id.indexOf('direct') != -1) {
        ...
        tip = '直接复制链接无效，请安装 IDM 及浏览器扩展后使用（https://github.com/syhyz1990/baiduyun/blob/master/help.md" target="_blank">脚本使用说明）';
        if (batchLinkList.length === 0) {
          alert('没有链接可以显示，API链接不要全部选中文件夹！');
          return;
        }
    ...
    function confirmClick() {
      ...
      if (result.errno == -20) {
        ...
        if (buttonTarget == 'download') {
          ...
          var tip = '直接复制链接无效，请安装 IDM 及浏览器扩展后使用（https://github.com/syhyz1990/baiduyun/blob/master/help.md" target="_blank">脚本使用说明）';
